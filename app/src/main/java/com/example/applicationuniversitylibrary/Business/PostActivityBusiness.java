...
public class PostActivityBusiness extends AppCompatActivity {
    ...
    private StorageTask mBusinessTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("Business");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mBusinessTask != null && mBusinessTask.isInProgress()){
                    Toast.makeText(PostActivityBusiness.this,"Upload in progress", Toast.LENGTH_SHORT).show();
                }else {
                    uploadPost();
                }
            }
    ...
    private void uploadPost() {
        ...
        if (mImageUri != null) {
            ...
            mBusinessTask = fileReference.putFile(mImageUri)
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            handler.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    startActivity(new Intent(PostActivityBusiness.this, BusinessActivity.class));
                                }

                            }, 100);

                            Toast.makeText(PostActivityBusiness.this, "Upload successful", Toast.LENGTH_LONG).show();
                            ...
                            Business post = new Business(mEditTextPostTitle.getText().toString().trim(),downloadUrl.toString(),
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(PostActivityBusiness.this, e.getMessage(),Toast.LENGTH_SHORT).show();
